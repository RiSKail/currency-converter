...
interface ChangeRouterProps {
  children: ReactNode
}

const ChangeRouter: React.FC<ChangeRouterProps> = ({ children }) => {
...
const Routers: React.FC<RouterProps> = ({ update }) => (
  <ChangeRouter>
    <React.Suspense fallback={<Loader />}>
      <Switch>
        <Route exact path={SIGN_PAGE_PATH} render={(): ReactNode => <SignPage update={update} />} />
        ...
        <SecuredRoute exact path={MAP_PAGE_PATH} render={(): ReactNode => <MapPage />} />
