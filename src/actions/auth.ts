...
export const signIn = (value: KeyableObj): AuthActionTypes => ({
  type: SIGN_IN,
  payload: value,
})

export const signInUserData = (value: KeyableObj): AuthActionTypes => ({
  type: SIGNIN_USER_DATA,
  payload: value,
})

export const signUp = (value: KeyableObj): AuthActionTypes => ({
  type: SIGN_UP,
  payload: value,
})
...
export const signError = (value: Error): AuthActionTypes => ({
  type: SIGN_ERROR,
  err: value,
})
...
export const setAuthCountryInfo = (data: KeyableObj): AuthActionTypes => ({
