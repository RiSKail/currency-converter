...
export const setBaseSecondaryType = (
  value: string,
): ValuesActionTypes => ({
...
export const setBasePrimaryValue = (
  value: string,
): ValuesActionTypes => ({
...
export const setBaseSecondaryValue = (
  value: string,
): ValuesActionTypes => ({
...
export const updateBaseSecondaryValue = (
  value: string,
): ValuesActionTypes => ({
...
export const updateBasePrimaryValue = (
  value: string,
): ValuesActionTypes => ({
